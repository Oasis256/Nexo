nsExtraComponents.nsMultiStoreStorePopup=defineComponent({template:`
...
background: linear-gradient(0deg, rgba(0,0,0,0.8379726890756303) 0%, rgba(0,0,0,0.7147233893557423) 32%, rgba(0,212,255,0) 100%);">
    ...
    `,props:["popup"],data(){return{__m,popupCloser,popupResolver,stores:[],hasLoaded:!1,...multistoreData}},mounted(){this.loadStores(),this.popupCloser()},methods:{close(){this.popupResolver(!1)},loadStores(){this.hasLoaded=!1,Axios.get("/api/multistores/stores").then(e=>{this.stores=e.data,this.hasLoaded=!0}).catch(e=>{this.hasLoaded=!0})}}});nsExtraComponents.nsMultistoreSelector=defineComponent({template:`
    ...
    `,data(){return{...multistoreData}},mounted(){},methods:{toggleStoreSelector(){Popup.show(nsExtraComponents.nsMultiStoreStorePopup)}}});
