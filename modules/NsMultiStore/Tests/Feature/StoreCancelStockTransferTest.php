    ...
    public function testExample()
    {
        ...
        $products->each(function ($product) {
            ...
            if ($oldProductQuantity !== $newQuantity) {
                throw new Exception(sprintf(__m('After transfect is canceled, the stock is no more the same : before => %s, after => %s', 'NsMultiStore'), $oldProductQuantity, $newQuantity));
            }
        });
